 ...
 * @author dwtj
 */
public class ModifierFactory extends ExceptingTreeVisitor<Void, Builder> implements MessageFactory<Builder> {
    ...
    public static List<Builder> makeAll(Iterable<AnnotationTree> annotations) {
        List<Builder> builders = new ArrayList<>();
        annotations.forEach(a -> builders.add(make(a)));
        return builders;
    }
    ...
    public Void visitAnnotation(AnnotationTree tree, Builder builder) {
        ...
        for (ExpressionTree arg : tree.getArguments()) {
            builder.addAnnotationValues(ExpressionFactory.make(arg));
        }
        return null;
    }
